...
कुछ दोस्त मुझे यूँ मिले हैं ऐसे
...
In this post, I present data analytics on my personal data that highlights 
the effects of / causes & some surprising benefits of being bipolar.

We start with a brief overview of what the polarity spectrum looks like & then quickly dive deep into the data and some visualisations.
